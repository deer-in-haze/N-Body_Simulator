from particles import CelestialBody, Particle
...
"""SOLAR SYSTEM"""
sun = CelestialBody(1.988e30, [OFFSET, OFFSET], [0, 0])
earth = CelestialBody(5.972e24, [AU + OFFSET, OFFSET], [0, 29766.5])
venus = CelestialBody(4.867e24, [OFFSET, 1.082e11 + OFFSET], [34995.75, 0])
mars = CelestialBody(6.39e23, [1.52 * AU + OFFSET, OFFSET], [0, 24130])
mercury = CelestialBody(3.285e23, [0.39 * AU + OFFSET, OFFSET], [0, 47400])
jupiter = CelestialBody(1.898e27, [5.20 * AU + OFFSET, OFFSET], [0, 13070, ])
saturn = CelestialBody(5.683e26, [9.58 * AU + OFFSET, OFFSET], [0, 9640])
uranus = CelestialBody(8.681e25, [19.18 * AU + OFFSET, OFFSET], [0, 6810])
neptune = CelestialBody(1.024e26, [30.07 * AU + OFFSET, OFFSET], [0, 5430])
"""LIST"""
...
moon = CelestialBody(7.342e22, [position_moon, 0], [0, velocity_moon])
"""EARTH SYSTEM"""
